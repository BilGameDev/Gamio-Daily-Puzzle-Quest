    ...
    public class SlideUpPopup : MonoBehaviour
    {
        ...
        protected void Open()
        {
            ...
            if (panelGroup != null)
            {
                ...
                rect.DOAnchorPos(mainCurrentPosition, 0.3f).SetEase(Ease.OutCubic);
            }
        }
        ...
        public virtual void Close()
        {
            ...
            if (panelGroup != null)
                seq.Join(((RectTransform)panelGroup.transform).DOAnchorPosY(-3000, 0.3f).SetEase(Ease.InCubic));
            seq.OnComplete(() =>
            {
                if (this != null)
                    Destroy(gameObject);
